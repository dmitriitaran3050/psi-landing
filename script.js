          ...
          options: [
            {
              ...
              insightText:
                "Злость здесь — важный сигнал. Она говорит, что ты видишь дисбаланс. Но продолжать, несмотря на злость — это часто про убеждение: «если я перестану давать, меня не будут любить». Дело не в щедрости — дело в том, на чём держится ощущение своей ценности в отношениях."
            },
            {
              id: "q1_a2",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              insightText:
                "Отсутствие счёта — тоже информация. Мы часто не замечаем хроники событий, потому что каждое воспринимается как «новое» и «случайное». Посмотреть на них вместе — первый шаг к тому, чтобы увидеть не случайность, а систему."
            }
          ]
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              insightText:
                "Скептицизм после нескольких болезненных финалов — это защита, а не слабость. Мозг рационализирует: «зачем пробовать, если будет то же самое». Только это та же логика, что и в сценарии — избегать неопределённого, потому что привычная боль хоть бы предсказуема. Попробовать — не значит поверить заранее."
            },
            {
              id: "q3_a4",
              ...
              insightText:
                "Первый раз задуматься — это не опоздание. Это точка отсчёта. Многие годами замечают симптомы, не называя их. То, что ты сейчас здесь и задаёшься себе эти вопросы — уже движение."
            }
          ]
        }
      ],
    ...
    self: {
      questions: [
          ...
          options: [
            {
              ...
              insightText:
                "Пустота в ответ на вопрос «чего хочу» — это не отсутствие желаний. Это сигнал, что контакт с собой где-то прервался. Обычно это происходит постепенно — когда долго живут в режиме «надо» и «должна». Желания никуда не делись. Они просто давно не получали разрешения."
            },
            {
              id: "q1_a2",
              ...
              insightText:
                "Когда вместо своего ответа всплывает чужой — это не слабость. Это результат долгого опыта, где свои желания были менее важны, чем ожидания других. Научиться хотеть своё — это не каприз. Это возвращение к себе, которое требует времени и безопасности."
            },
            {
              id: "q1_a3",
              label: "Что-то мелькает — но быстро гаснет",
              insightTitle: "То, что мелькает — это и есть ты",
              insightText:
                "Желание мелькнуло — и тут же пришло «это несерьёзно», «не время», «другие важнее». Это не свой голос. Это голос, который ты усвоила давно — и который научился опережать собственные импульсы. То, что мелькает — стоит замечать. Именно там и есть ты."
            },
            {
              id: "q1_a4",
        ...
        },
        {
          id: "q2",
          progressLabel: "Вопрос 2 из 3",
          title: "Что чаще всего мешает слушать себя?",
          options: [
            {
              id: "q2_a1",
              ...
              insightText:
                "Интересная вещь про занятость: она не просто забирает время. Она даёт ощущение, что ты в порядке — пока двигаешься, пока нужна, пока справляешься. Останавливаться страшнее, чем кажется. Потому что в тишине появляется то, что давно ждёт разговора."
            },
            {
              id: "q2_a2",
              label: "Слушаю — но не знаю, можно ли этому доверять",
              insightTitle: "Недоверие к себе — это чужой голос",
              insightText:
                "Недоверие к себе — это не про тебя сейчас. Это про кого-то из прошлого, чья оценка однажды оказалась важнее своей собственной. Ты просто продолжаешь её воспроизводить — уже без него. А это означает, что голос, который не доверяет — не свой. Чужое всегда можно вернуть."
            },
            {
              id: "q2_a3",
              ...
              insightText:
                "Если «не знала никогда» — значит вопрос «чего хочу» где-то очень рано перестал быть безопасным. Не задавался, не поощрялся, не получал ответа. И психика просто перестала его поднимать. Это не характер — это история."
            },
            {
              id: "q2_a4",
              label: "Честно — не думала об этом до сегодня",
              insightTitle: "Первый раз — уже движение",
              insightText:
          ...
          options: [
            {
              ...
              insightText:
                "Когда долго живут в режиме «сначала все остальные» — желания не исчезают. Они просто перестают казаться важными. Сначала откладываешь. Потом забываешь спросить. Потом уже не знаешь, что спрашивать. Это не потеря себя — это очень долгая привычка себя не замечать."
            },
            {
              id: "q3_a2",
              ...
              insightText:
                "Бывает, что одно событие меняет всё — и то, что раньше казалось понятным, вдруг перестаёт работать. Не потому что ты сломалась. А потому что стала другой. А новой тебе нужно время, чтобы разобраться, чего она хочет."
            },
            {
              id: "q3_a3",
      ...
      patterns: [
        {
          ...
          paragraphs: [
            ...
            "Вопрос, который стоит унести с собой: что мешает мне слушать себя — и давно ли я перестала пробовать?",
          ]
        }
      ],
      resultRule: {
          ...
          options: [
            {
              ...
              insightText:
                "Тело умнее, чем кажется. Когда оно не двигается — это не сбой. Это сигнал: где-то впереди что-то опасное. Не для логики — для какой-то старой части внутри. Она не знает, что ты уже выросла. Она всё ещё останавливает тебя от того, что давно прошло."
            },
            {
              id: "q1_a2",
            ...
            {
              id: "q1_a3",
              label: "Пугает — хоть умом понимаю, что всё нормально",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              insightText:
                "Если потолок существует столько, сколько себя помнишь — он появился не из карьерных неудач. Он появился раньше. Из чего-то, что когда-то сказало: вот твоё место. А с тех пор ты очень точно его держишь."
            },
            {
              id: "q2_a4",
              ...
              insightText:
                "Остановиться и заметить — уже немало. Пока двигаешься на автопилоте — многое остаётся невидимым. Именно в паузе становится слышно то, что давно работает фоном. А это уже другая точка, чем вчера."
            }
          ]
        },
        {
          ...
          options: [
            {
              id: "q3_a1",
              label: "Недостаточно стараться — надо просто взять себя в руки",
              insightTitle: "Самообвинение — удобное, но неточное объяснение",
              insightText:
                "Самообвинение через «надо стараться больше» — удобное объяснение. Оно знакомое, привычное и не требует смотреть глубже. Только если бы дело было в усилии — ты бы уже давно пробила этот потолок. Ты явно не из тех, кто не старается."
            },
            {
              id: "q3_a2",
            ...
            {
              id: "q3_a4",
              label: "Честно — не знаю. А это само по себе странно",
      ...
      patterns: [
        {
          ...
          paragraphs: [
            "Потолок, который не пробивается годами — почти никогда не снаружи. Он встроен изнутри. Точно, незаметно, давно. А именно поэтому его не берут ни курсы, ни марафоны, ни сила воли.",
      ...
      questions: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              insightText:
                "Занятость не решает то, что беспокоит — она просто делает его тише. Пока двигаешься — не слышно. Останавливаешься — и оно снова здесь. Это не плохая стратегия. Просто временная."
            },
            {
              id: "q1_a3",
              ...
              insightText:
                "Анализ — это попытка решить через голову то, что живёт глубже головы. Понять причины и почувствовать облегчение — разные вещи. Можно очень точно знать, почему тебе тяжело — и всё равно продолжать чувствовать именно это."
            },
            {
              id: "q1_a4",
              ...
              insightText:
                "Не думать — тоже стратегия. Энергозатратная. Держать что-то подальше от сознания требует постоянного усилия — даже если его не замечаешь. Именно поэтому к вечеру так устаёшь, хоть, кажется, ничего особенного не делала."
            }
          ]
        },
        {
          ...
          options: [
            {
              id: "q2_a1",
              label: "Что окажется тяжелее, чем думала",
            ...
            {
              id: "q2_a4",
              label: "Что ничего не изменится — и это всё зря",
        ...
        },
        {
          ...
          options: [
            {
              id: "q3_a1",
              label: "Что в порядке — даже если не идеальна",
            ...
            },
            {
              ...
              insightText:
                "Мы не теряем желания — мы теряем разрешение на них. В какой-то момент стало понятно, что хотеть что-то своё — небезопасно или бесполезно. А желания никуда не исчезли. Они просто перестали проситься наружу."
            },
            {
              id: "q3_a3",
              ...
              insightText:
                "Невозможность выдохнуть — это не тревожность как черта характера. Это встроенная бдительность. Где-то в опыте расслабиться действительно было опасно. Тело запомнило — и продолжает стоять. Даже когда угрозы давно нет."
            },
            {
              id: "q3_a4",
              label: "Что наконец понимаю, что со мной происходит",
      ...
      patterns: [
        {
          ...
          paragraphs: [
            ...
            "Вопрос, который стоит унести с собой: что именно я хочу сохранить — и от чего?",
          ]
        }
      ],
      resultRule: {
  ...
  appNode.innerHTML = `
    <section class="screen">
      ...
      <div class="insight-card">
        <h2 class="insight-title">${escapeHtml(insight.insightTitle)}</h2>
  ...
  appNode.innerHTML = `
    <section class="screen">
      ...
      <div class="pattern-card">
        ${pattern.paragraphs.map((p) => `<p>${escapeHtml(p)}</p>`).join("")}
      </div>
      <div class="dice-card">
